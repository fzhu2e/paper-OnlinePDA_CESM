...
!
! !REVISION HISTORY:
!  SVN:$Id: forcing_pt_interior.F90 63792 2014-09-25 14:36:26Z mlevy@ucar.edu $
!
! !USES
...
!-----------------------------------------------------------------------
   ...
   case ('annual')
      ...
      pt_interior_data_names(1) = 'TEMPERATURE_diff'
   ...
   case ('monthly-equal','monthly-calendar')
      ...
      do n=1,12
         ...
         write(pt_interior_data_names(n),'(a16,i2.2)') 'TEMPERATURE_diff',n

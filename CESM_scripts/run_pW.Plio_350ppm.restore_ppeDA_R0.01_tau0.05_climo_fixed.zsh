...
R=0.01
CO2=350ppm
casetag=pW.Plio_${CO2}.restore_ppeDA_R${R}_tau0.05_climo_fixed
account=UAZN0034
priority=regular
...
branch_case=b.e13.B1850C5CN.ne30_g16.icesm131_ihesp.pW.Plio_${CO2}.restore_ppeDA_R${R}_tau0.05_climo
branch_date=0881-01-01
...
# Add modules
# ----------------------------------------------
print_hint '>>> Adding mods'
cp ${0:A:h}/forcing_pt_interior_fixed.F90 ${case_dir}/SourceMods/src.pop/forcing_pt_interior.F90
# ==============================================
